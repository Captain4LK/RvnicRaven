...
#ifdef RVR_DRAW_IMPLEMENTATION
#ifndef RVR_DRAW_IMPLEMENTATION_ONCE
#define RVR_DRAW_IMPLEMENTATION_ONCE

static uint16_t rvr_draw_font_id = 0;
...
void RvR_draw_string(int x, int y, int scale, const char *text, uint8_t index)
{
   RvR_texture *draw_font = RvR_texture_get(rvr_draw_font_id);
