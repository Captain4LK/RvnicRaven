...
//Function prototypes
void camera_update();
static void move_with_collision(RvR_fix22_vec3 offset, int8_t compute_height, int8_t compute_plane, RvR_fix22 *floor_height, RvR_fix22 *ceiling_height);
...
static void move_with_collision(RvR_fix22_vec3 offset, int8_t compute_height, int8_t compute_plane, RvR_fix22 *floor_height, RvR_fix22 *ceiling_height)
{
   ...
   if(compute_plane)
   {
      ...
      //int16_t x_square = (corner.x/1024);
      //int16_t y_square = (corner.y/1024);
      ...
      ///x_square_new = (corner_new.x/1024);
      ///y_square_new = (corner_new.y/1024);
