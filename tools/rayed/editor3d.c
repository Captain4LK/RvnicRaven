...
static void mouse_world_pos(int mx, int my, int16_t *x, int16_t *y, int *location)
{
   ...
   RvR_fix22 ray_start_floor_height = RvR_ray_map_floor_height_at((RvR_ray_get_position().x / 1024), (RvR_ray_get_position().y / 1024)) - 1 * RvR_ray_get_position().z;
   RvR_fix22 ray_start_ceil_height = RvR_ray_map_ceiling_height_at((RvR_ray_get_position().x / 1024), (RvR_ray_get_position().y / 1024)) - 1 * RvR_ray_get_position().z;
   ...
   r.start = (RvR_fix22_vec2) {
      RvR_ray_get_position().x, RvR_ray_get_position().y
   };
