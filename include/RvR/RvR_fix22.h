...
inline RvR_fix22 RvR_fix22_mul(RvR_fix22 a, RvR_fix22 b) { return (RvR_fix22)(((int64_t)a * b) / 1024); }
inline RvR_fix22 RvR_fix22_div(RvR_fix22 a, RvR_fix22 b) { return (RvR_fix22)(((int64_t)a * 1024) / b); }
